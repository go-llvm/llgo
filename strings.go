...
func (c *compiler) concatenateStrings(lhs, rhs *LLVMValue) *LLVMValue {
	strcat := c.RuntimeFunction("runtime.strcat", "func(a, b _string) _string")
...
func (c *compiler) compareStrings(lhs, rhs *LLVMValue, op token.Token) *LLVMValue {
	strcmp := c.RuntimeFunction("runtime.strcmp", "func(a, b _string) int32")
...
func (c *compiler) stringNext(strval, index llvm.Value) (consumed, value llvm.Value) {
	strnext := c.RuntimeFunction("runtime.strnext", "func(s _string, i int) (int, rune)")
...
func (v *LLVMValue) runeToString() *LLVMValue {
	c := v.compiler
	strrune := c.RuntimeFunction("runtime.strrune", "func(n int64) _string")
...
func (v *LLVMValue) stringToRuneSlice() *LLVMValue {
	c := v.compiler
	strtorunes := c.RuntimeFunction("runtime.strtorunes", "func(_string) slice")
...
func (v *LLVMValue) runeSliceToString() *LLVMValue {
	c := v.compiler
	runestostr := c.RuntimeFunction("runtime.runestostr", "func(slice) _string")
